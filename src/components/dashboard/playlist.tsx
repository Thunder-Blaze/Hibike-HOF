...
const Playlist = ({ playlist }: { playlist: TypePlaylist }) => {
    return (
        <div className="flex flex-col relative items-center justify-center">
            ...
            />
            <div
                className="flex justify-between items-center rounded-md absolute text-background bottom-3 p-2.5 py-1.5 w-full bg-foreground/50"
                style={{
            ...
            >
                <div className="flex flex-col">
                    ...
                    <p className="text-xs text-card-background/60 flex gap-1 items-center justify-start">
