...
export default function PlayerPage() {
  ...
  return (
    <>
      <Header showBackButton title="Player" />
      <div className="flex min-h-screen flex-col items-center justify-center bg-gradient-to-b from-background to-muted/20 p-8 pt-24">
